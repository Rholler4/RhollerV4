...
latitude_var = tk.StringVar(value="Latitude: 37.71257665492287")
longitude_var = tk.StringVar(value="Longitude: -121.07970728190752")
...
tilt_x_var = tk.StringVar(value="Tilt X: 15" + " degrees")
tilt_y_var = tk.StringVar(value="Tilt Y: -12" + " degrees")
...
temperature_var = tk.StringVar(value="Temperature: 80" + "F")
...
cpu_usage_var = tk.StringVar(value="CPU Usage: -")
ram_usage_var = tk.StringVar(value="RAM Usage: -")
...
headlight_power_var = tk.StringVar(value="Headlight Power: -")
...
error_code_var = tk.StringVar(value="Error Codes: -")
...
steering_angle_var = tk.StringVar(value="Steering Angle: -")
throttle_var = tk.StringVar(value="Throttle: -")
